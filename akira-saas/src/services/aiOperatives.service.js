 ...
 * Steps: Create client â†’ Send welcome â†’ Create project â†’ Assign manager
 */
 ...
 * Steps: Get time entries â†’ Calculate hours â†’ Generate PDF â†’ Send to client
 */
 ...
 * Steps: Get daily activity â†’ Identify blockers â†’ Create summary â†’ Post report
 */
 ...
 * Steps: Calculate metrics â†’ Identify trends â†’ Generate insights
 */
 ...
 * Steps: Add to CRM â†’ Send intro â†’ Schedule follow-up â†’ Track engagement
 */
...
export function formatWorkflowResult(result) {
  ...
  return {
    status: result.success ? 'âœ… Success' : 'âŒ Failed',
